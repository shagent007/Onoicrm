...
import {FieldAttribute} from "~/modules/app-form";
import {remove} from "~/shared/lib/helpers"
import { CollectionField } from './models/CollectionField';
import { defaultMessage, IMessage } from '~/shared/models/notification/IMessage';
...
const attrs = computed(() => {
  ...
  if (isRef(attrs)) return attrs.value as FieldAttribute;
  return attrs as FieldAttribute;
});
