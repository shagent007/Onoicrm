...
public class SymptomController : AdminObjectController<Symptom>
{
    public SymptomController(IConfiguration configuration, ApplicationDataContext dataContext, UserManager<IdentityUser> userManager) : base(configuration, dataContext,userManager)
    {
    }
}